...
async def load_csv(source: str, doc_type: str, embed_fields: Optional[List[str]] = None) -> List[Document]:
...
async def load_documents(source: str, doc_type: str, embed_fields: Optional[List[str]] = None) -> List[Document]:
